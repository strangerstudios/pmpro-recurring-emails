...
= .5 =
BUG/FIX: Would send redundant reminders to certain users
ENHANCEMENT: Simplified update logic for email reminders
REFACTOR: Made mail substitution array code a little more readable
